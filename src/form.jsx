...
const Form = () => {
  ...
  return (
    <div className="col-lg-12" id="form-here">
      <div className="row pt-lg-5 w-100 align-items-center">
        <div className="col-lg-6">
          <div className="frm-btn text-center">
            <img src="./codingbot-img.png" className='w-50' alt="" />
            {/* <span className="static-title">Contact Form</span> */}
          </div>
        </div>
        <div className="col-lg-6">
